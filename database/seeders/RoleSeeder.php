    ...
    private function assignRolePermissions(): void
    {
        ...
        if ($managerRole) {
            $managerPermissions = [
                ...
                'view_employee_types', 'manage_employee_types',
                'view_employee_documents', 'manage_employee_documents',
                'verify_employee_documents', 'unverify_employee_documents',
                'view_caste_management', 'view_caste_ratio', 'manage_cast_ratios',
                'view_village_description', 'manage_village_descriptions',
                'view_panchayat_choosings', 'manage_panchayat_choosings',
                'view_village_choosings', 'manage_village_choosings',
                'view_education_management', 'manage_educations',
                'view_expense_category_management', 'manage_expense_categories',
                'view_category_management', 'manage_categories',
        ...
        if ($employeeRole) {
            $employeePermissions = [
                ...
                'view_panchayat_choosings',
                'view_village_choosings',
                'view_education_management',
                'view_expense_category_management',
